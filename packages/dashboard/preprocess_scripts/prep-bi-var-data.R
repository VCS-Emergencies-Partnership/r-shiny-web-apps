...
g.legend =
  ...
  labs(x = "Higher vulnerability",
       y = "Higher capacity")+
  theme(axis.title = element_text(color = "black", size = 40),
        axis.title.y = element_text(angle = 90, vjust = -8, hjust = 0.5)) +
  coord_fixed() +
...
par()
g.legend
dev.print(png, '../www/bivar-legend_v2.png', bg="transparent",width=800, height=600)
dev.off()
